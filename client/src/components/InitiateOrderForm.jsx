...
err.response?.data?.message || '❌ Failed to initiate order. Please try again.'
...
<option value="Annapurna">Annapurna Canteen</option>
...
<label className="block text-sm font-semibold mb-1">Product Links or Names</label>
...
placeholder="Paste product links or item names..."
...
placeholder="e.g., suhani@instapal"
...
<label className="block text-sm font-semibold mb-1">Upload QR Code (optional)</label>
...
{loading ? 'Submitting...' : '🚀 Start Order'}
...
className="bg-gray-300 hover:bg-gray-400 text-black font-medium px-4 py-2 rounded-lg"
